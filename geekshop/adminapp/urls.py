...
urlpatterns = [
    ...
    path('product/create/<int:pk>', admin_views.product_create, name='product_create'),
    path('products/<int:pk>/', admin_views.products, name='products_list'),
    path('product/update/<int:pk>/', admin_views.product_update, name='product_update'),
    path('product/delete/<int:pk>/', admin_views.product_delete, name='product_delete'),
    path('product/detail/<int:pk>/', admin_views.product_detail, name='product_detail'),
